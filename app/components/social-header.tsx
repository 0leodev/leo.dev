...
const SocialLink = memo(function SocialLink({
  ...
  return (
    ...
    >
      {Icon === 'X' ? (
        <svg className="social-icon-header" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Icon className="social-icon-header" />
      )}
    </a>
  )
})
...
export default memo(function SocialFooter() {
  ...
  return (
    <footer className="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 md:px-12 relative">
